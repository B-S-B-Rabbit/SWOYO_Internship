...
class MyTestCase(TestCase):
    def test_not_open(self):
        self.assertEqual(text_stat('trouble_file(not_found)'),
    ...
    def test_simple_text(self):
        self.assertEqual(text_stat("simple_text"),
                         {'a': (0, 0.0), 'b': (0, 0.0), 'c': (0, 0.0), 'd': (2, 0.16666666666666666),
                          'e': (3, 0.16666666666666666), 'f': (0, 0.0), 'g': (0, 0.0), 'h': (0, 0.0),
                          'i': (1, 0.08333333333333333), 'j': (0, 0.0), 'k': (0, 0.0), 'l': (1, 0.08333333333333333),
                          'm': (2, 0.08333333333333333), 'n': (0, 0.0), 'o': (1, 0.08333333333333333),
                          'p': (1, 0.08333333333333333), 'q': (0, 0.0), 'r': (1, 0.08333333333333333),
                          's': (2, 0.16666666666666666), 't': (0, 0.0), 'u': (0, 0.0), 'v': (0, 0.0), 'w': (0, 0.0),
                          'x': (0, 0.0), 'y': (0, 0.0), 'z': (0, 0.0), 'A': (0, 0.0), 'B': (0, 0.0), 'C': (0, 0.0),
                          'D': (0, 0.0), 'E': (0, 0.0), 'F': (0, 0.0), 'G': (0, 0.0), 'H': (0, 0.0), 'I': (0, 0.0),
                          'J': (0, 0.0), 'K': (0, 0.0), 'L': (0, 0.0), 'M': (0, 0.0), 'N': (0, 0.0), 'O': (0, 0.0),
                          'P': (0, 0.0), 'Q': (0, 0.0), 'R': (0, 0.0), 'S': (0, 0.0), 'T': (0, 0.0), 'U': (0, 0.0),
                          'V': (0, 0.0), 'W': (0, 0.0), 'X': (0, 0.0), 'Y': (0, 0.0), 'Z': (0, 0.0),
                          'а': (1, 0.08333333333333333), 'б': (0, 0.0), 'в': (0, 0.0), 'г': (0, 0.0),
                          'д': (1, 0.08333333333333333), 'е': (1, 0.08333333333333333), 'ж': (0, 0.0), 'з': (0, 0.0),
                          'и': (1, 0.08333333333333333), 'й': (1, 0.08333333333333333), 'к': (0, 0.0),
                          'л': (2, 0.16666666666666666), 'м': (1, 0.08333333333333333), 'н': (1, 0.08333333333333333),
                          'о': (0, 0.0), 'п': (0, 0.0), 'р': (0, 0.0), 'с': (1, 0.08333333333333333),
                          'т': (1, 0.08333333333333333), 'у': (0, 0.0), 'ф': (1, 0.08333333333333333), 'х': (0, 0.0),
                          'ц': (0, 0.0), 'ч': (1, 0.08333333333333333), 'ш': (0, 0.0), 'щ': (0, 0.0), 'ъ': (0, 0.0),
                          'ы': (0, 0.0), 'ь': (0, 0.0), 'э': (0, 0.0), 'ю': (0, 0.0), 'я': (1, 0.08333333333333333),
                          'А': (0, 0.0), 'Б': (0, 0.0), 'В': (0, 0.0), 'Г': (0, 0.0), 'Д': (0, 0.0), 'Е': (0, 0.0),
                          'Ж': (0, 0.0), 'З': (0, 0.0), 'И': (0, 0.0), 'Й': (0, 0.0), 'К': (0, 0.0), 'Л': (0, 0.0),
                          'М': (0, 0.0), 'Н': (0, 0.0), 'О': (0, 0.0), 'П': (0, 0.0), 'Р': (0, 0.0), 'С': (0, 0.0),
                          'Т': (0, 0.0), 'У': (0, 0.0), 'Ф': (0, 0.0), 'Х': (0, 0.0), 'Ц': (0, 0.0), 'Ч': (0, 0.0),
                          'Ш': (0, 0.0), 'Щ': (0, 0.0), 'Ъ': (0, 0.0), 'Ы': (0, 0.0), 'Ь': (0, 0.0), 'Э': (0, 0.0),
                          'Ю': (0, 0.0), 'Я': (0, 0.0), 'word_amount': 12, 'paragraph_amount': 1,
                          'bilingual_word_amount': 1}
                         )

    # def test_big_data(self):
    # self.assertEqual(text_stat('TREMENDOUS').get('error', 0), 0)
